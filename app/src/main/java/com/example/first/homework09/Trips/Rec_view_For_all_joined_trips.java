package com.example.first.homework09.Trips;
        ...
        import com.example.first.homework09.Joined_trips_activity;
...
public class Rec_view_For_all_joined_trips extends  RecyclerView.Adapter<Rec_view_For_all_joined_trips.RecViewHolder>{
    ...
    public Rec_view_For_all_joined_trips(List<Trip> arrayList, Context context,TripsInterface friendsInterface) {
    ...
    @Override
    public Rec_view_For_all_joined_trips.RecViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.rec_view_for_frnds_trips_list, parent, false);
        return new Rec_view_For_all_joined_trips.RecViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final Rec_view_For_all_joined_trips.RecViewHolder holder, final int position) {
